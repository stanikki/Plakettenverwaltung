...
// WSDL     : https://plakettenvt.de.tuv.com/sap/bc/srt/rfc/sap/Z_PLV_GET_SVDATA_V01?sap-client=010&wsdl=1.1
//  >Import : https://plakettenvt.de.tuv.com/sap/bc/srt/rfc/sap/Z_PLV_GET_SVDATA_V01?sap-client=010&wsdl=1.1:0
// Encoding : utf-8
// Codegen  : [wfAllowOutParameters+]
// Version  : 1.0
// (14.02.2011 09:33:41 - - $Rev: 10138 $)
// ************************************************************************ //

unit Z_PLV_GET_SVDATA_V011;
...
type
  ...
  ZPLV_VBBST_V01       = class;                 { "urn:sap-com:document:sap:rfc:functions"[GblCplx] }
  ...
  TableOfZPLV_APLAK_V01 = array of item;        { "urn:sap-com:document:sap:rfc:functions"[GblCplx] }
  TableOfZPLV_EPLAK_V01 = array of item2;       { "urn:sap-com:document:sap:rfc:functions"[GblCplx] }
  TableOfZPLV_TSBST_V01 = array of item3;       { "urn:sap-com:document:sap:rfc:functions"[GblCplx] }
  TableOfZPLV_VBBST_V01 = array of item4;       { "urn:sap-com:document:sap:rfc:functions"[GblCplx] }
  ...
  // ************************************************************************ //
  // XML       : ZPLV_VBBST_V01, global, <complexType>
  // Namespace : urn:sap-com:document:sap:rfc:functions
  // ************************************************************************ //
  ZPLV_VBBST_V01 = class(TRemotable)
  private
    FPLJAHR: numeric4;
    FPLTYP: char3;
    FPLBST: char11;
  ...
  // style     : document
  // binding   : Z_PLV_GET_SVDATA_V01SoapBinding
  // service   : Z_PLV_GET_SVDATA_V01Service
  // port      : Z_PLV_GET_SVDATA_V01SoapBinding
  // URL       : http://trg101.de.tuv.com:1080/sap/bc/srt/rfc/sap/Z_PLV_GET_SVDATA_V01?sap-client=010
  // ************************************************************************ //
  Z_PLV_GET_SVDATA_V01 = interface(IInvokable)
  ['{E2ECFE55-6739-3E17-BA35-867C5C32437B}']
    procedure Z_PLV_GET_SVDATA_V01(var ET_APLAK_V01: TableOfZPLV_APLAK_V01; var ET_EPLAK_V01: TableOfZPLV_EPLAK_V01; var ET_TSBST_V01: TableOfZPLV_TSBST_V01; var ET_VBBST_V01: TableOfZPLV_VBBST_V01; const IF_PLJAHR: numeric4; const IF_PLVV: char5; 
                                   const IS_SVKPF_V01: ZPLV_SVKPF_V01; out ES_MSG: ZPLV_MESSAGE_V01; out ES_SVKPF_V01: ZPLV_SVKPF_V01); stdcall;
  end;

function GetZ_PLV_GET_SVDATA_V01(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): Z_PLV_GET_SVDATA_V01;


implementation
  uses SysUtils;

function GetZ_PLV_GET_SVDATA_V01(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): Z_PLV_GET_SVDATA_V01;
const
  defWSDL = 'https://plakettenvt.de.tuv.com/sap/bc/srt/rfc/sap/Z_PLV_GET_SVDATA_V01?sap-client=010&wsdl=1.1';
  defURL  = 'http://trg101.de.tuv.com:1080/sap/bc/srt/rfc/sap/Z_PLV_GET_SVDATA_V01?sap-client=010';
  defSvc  = 'Z_PLV_GET_SVDATA_V01Service';
  defPrt  = 'Z_PLV_GET_SVDATA_V01SoapBinding';
var
  RIO: THTTPRIO;
begin
  Result := nil;
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as Z_PLV_GET_SVDATA_V01);
    if UseWSDL then
    begin
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(Z_PLV_GET_SVDATA_V01), 'urn:sap-com:document:sap:rfc:functions', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(Z_PLV_GET_SVDATA_V01), '');
  InvRegistry.RegisterInvokeOptions(TypeInfo(Z_PLV_GET_SVDATA_V01), ioDocument);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(TableOfZPLV_VBBST_V01), 'urn:sap-com:document:sap:rfc:functions', 'TableOfZPLV_VBBST_V01');
  ...
  RemClassRegistry.RegisterXSClass(ZPLV_VBBST_V01, 'urn:sap-com:document:sap:rfc:functions', 'ZPLV_VBBST_V01');
